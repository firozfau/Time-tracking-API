...
class AuthController:
    ...
    async def registration(self, data):
        ...
        if data:
            ...
            if isSqlData:
                ...
                elif (sqlEmail.get('status') == "success"):
    ...
    async def logout(self,data):
        if data:
            ...
            if checkIP['status']:
                loginData= await self.authModel.loginDataByToken(data.sessionToken)
                if loginData:
    ...
    async def changePassword(self, data):
        if data:
            ...
            if checkIP['status']:
                ...
                if isSqlEmail or isSqlNewPassword or  isSqlCurrentPassword:
                    return self.mgsLib.default("sql")
                else:
                    ...
                    if userData:
                        ...
                        if userData['status']=="success":
                            ...
                            if checkPassword['status']=="success":
                                ...
                                return {
                                    "status": "error",
                                    "message": "The current password does not match our records. Please enter the correct password.",
                                    "data": data
                                }
                        else:
                            return {
