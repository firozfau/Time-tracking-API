...
class GeneralController:
    ...
    async def countriesList(self, data):
        if data:
            ...
            if checkIP['status']:
               ...
               countryList= await self.generalModel.getData(data,"countryNameList")

               return {
                   "status": "success",
                   "message": "The country name list has been successfully retrieved",
                   "data": countryList
               }
    ...
    async def userAllList(self, data):
        if data:
            ...
            if checkIP['status']:
                ...
                userList = await self.generalModel.getData(data, "userAllList")

                return {
                    "status": "success",
                    "message": "The users list has been successfully retrieved",
                    "data": userList
                }
    ...
    async def eventNameList(self, data):
        if data:
            ...
            if checkIP['status']:
               ...
               eventNamelist= await self.superModel.getData(data,"eventNameList")
    ...
    async def userConfigAllList(self, data):
        if data:
            ...
            if checkIP['status']:
                ...
                userConfigList = await self.generalModel.getData(data, "userConfigAllList")
                if userConfigList['status']=="success":
                    return {
                        "status": "success",
                        "message": "The customize TTS user list has been successfully retrieved",
                        "data": userConfigList
                    }
                else:
        ...
        if data:
            ...
            if checkIP['status']:
                ...
                if userConfigList['status']=="success":
                    return {
                        "status": "success",
                        "message": "The User data has been successfully retrieved",
                        "data": userConfigList
                    }
                else:
                    return self.mgsLib.getMessage(userConfigList['status'],False,data)
        ...
        if data:
            ...
            if checkIP['status']:
                ...
                if isComments:
                    ...
                    isAlreadyExist = await self.generalModel.getUserConfigInfoByUserID(data.user_id)

                    if isAlreadyExist:
                        return self.mgsLib.insertMessage("exist", False, False)
                    else:
