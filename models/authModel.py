...
#================================= insert data ================================================
    ...
    async def userRegistration(self, data,objectData):
        ...
        sqlQuery = text(
            """
            INSERT INTO users (`account_type_id`, `office_id`, `department_id`, `designation_id`, `gender`, `first_name`, `last_name`, `email`, `mobile_number`, `terms_condition`, `user_ip`, `comments`, `user_photo`, `username`, `password`, `verify_token`, `created_id`)
            VALUES (:account_type_id, :office_id, :department_id, :designation_id, :gender, :first_name, :last_name, :email, :mobile_number, :terms_condition, :user_ip, :comments, :user_photo, :username, :password, :verify_token, :created_id)
            """
        )
...
#================================= base query data ================================================
    ...
    async def getUserTTSConfigInformation(self, user_id):
        try:
            ...
            sql_query = text(""" 
            SELECT tts_user_config.office_id, tts_user_config.user_id,tts_user_config.joining_date,
    ...
    async def loginDataByToken(self,sessionToken):
        try:
            sql_query = text(
